...
public partial class UCE_UI_CharacterCreation : MonoBehaviour
{
    ...
    public virtual void SetCharacterClass(int _classIndex)
    {
        ...
        for (int i = 0; i < ((PlayerEquipment)players[classIndex].equipment).slotInfo.Length; ++i)
        {
            EquipmentInfo info = ((PlayerEquipment)players[classIndex].equipment).slotInfo[i];
