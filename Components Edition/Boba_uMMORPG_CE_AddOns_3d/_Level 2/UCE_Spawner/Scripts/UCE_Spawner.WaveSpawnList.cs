            ...
            while (totalObjectsSpawned < totalObjectsToSpawn)
            {
                ...
                if (idx != -1 && (spawnablePrefabs[idx].amount < spawnablePrefabs[idx].maxAmount || spawnablePrefabs[idx].maxAmount == 0))
                {
                    ...
                    if (go.GetComponent<Entity>())
                    {
                        ...
                        {
                            go.GetComponent<Entity>().level.current = (int)(go.GetComponent<Entity>().level.current + _levelAdjustment) / 2;
                        }
                        ...
                        {
                            go.GetComponent<Entity>().level.current = (int)(go.GetComponent<Entity>().level.current + _lastPlayerLevel + _levelAdjustment) / 2;
                        }
                    }
