...
public partial class Entity
{
    ...
    public virtual int moraleMax
    {
        get
        {
            ...
            for (int i = 0; i < skills.buffs.Count; ++i)
                buffBonus += skills.buffs[i].bonusMoraleMax;

            // base + passives + buffs
            return _moraleMax.Get(level.current) + passiveBonus + buffBonus;
        }
    }
    ...
    public virtual bool moraleRecovery
    {
        get
        {
            return moraleRecoveryRate < 0 || (_moraleRecovery && !skills.buffs.Any(x => x.blockMoraleRecovery));
        }
    }
    ...
    public int moraleRecoveryRate
    {
        get
        {
            ...
            // base + passives + buffs
            return _moraleRecoveryRate.Get(level.current) + Convert.ToInt32(passivePercent * moraleMax) + Convert.ToInt32(buffPercent * moraleMax);
        }
    }
